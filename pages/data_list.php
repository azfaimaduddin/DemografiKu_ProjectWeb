...
$lakiLaki = count(array_filter($penduduk, function($p) { return $p['jenis_kelamin'] === 'Laki-laki'; }));
$perempuan = count(array_filter($penduduk, function($p) { return $p['jenis_kelamin'] === 'Perempuan'; }));
?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <div class="table-actions">
                            <span class="badge bg-light text-dark" id="dataCount"><?php echo $totalPenduduk; ?> data</span>
                        ...
                        <tr class="data-row" data-gender="<?php echo $p['jenis_kelamin']; ?>">
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <button class="btn btn-sm btn-info btn-action-view" 
                                            data-bs-toggle="tooltip" 
                                            title="Lihat Detail"
                                            onclick="showDetail('<?php echo $p['nik']; ?>')">
...
function showDetail(nik) {
    ...
    // For now, we'll show a simple detail view
    const detailContent = `
        <div class="row">
...
function exportData() {
    alert('Fitur export data akan tersedia dalam pengembangan selanjutnya!');
}
...
.nik-cell, .date-cell, .wilayah-cell {
    display: flex;
    align-items: center;
}
